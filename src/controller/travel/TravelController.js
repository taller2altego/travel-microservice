...
class TravelController {
  ...
  acceptTravel(req, res, next) {
    ...
    return TravelService
      ...
      .then(travel => {
        const data = travel;
        res.customResponse = { statusCode: 204, message: 'Travel accepted' };
        next();
      })
      .catch((err) => {
  ...
  rejectTravel(req, res, next) {
    ...
    return TravelService
      ...
      .then(travel => {
        const data = travel;
        res.customResponse = { statusCode: 204, message: 'Travel rejected' };
        next();
      })
      .catch((err) => {
        logger.error(JSON.stringify(err));
  ...
  startTravel(req, res, next) {
    ...
    return TravelService
      ...
      .then(travel => {
        const data = travel;
        res.customResponse = { statusCode: 204, message: 'Travel started' };
        next();
      })
      .catch((err) => {
        logger.error(JSON.stringify(err));
  ...
  finishTravel(req, res, next) {
    ...
    return TravelService
      ...
      .then(travel => {
        const data = travel;
        res.customResponse = { statusCode: 204, message: 'Travel finished' };
        next();
      })
      .catch((err) => {
        logger.error(JSON.stringify(err));
